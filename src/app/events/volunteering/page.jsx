  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        const volunteerEvents = response.data.filter(event => event.category === 'volunteer');
        ...
        <div className="max-w-6xl mx-auto">
         ...
         <div>
           ...
           <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <FadeInSection>
              <div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-gray-200">Coming Soon</h1>
                <p className="text-lg text-gray-300">We are working on bringing you exciting volunteer opportunities. Stay tuned!</p>
              </div>
            </FadeInSection>
          )}
        </div>
