...
const Button = () => {
    return (
      ...
      <div
        className="btn md:w-[60%] ml-5 mr-3 md:flex md:bg-main bg-third text-white md:border-third  border-2 rounded-2xl md:hover:bg-third hover:bg-third/50 hover:text-white hover:border-secondary "
      >
        Join IHSAN
      </div>
    </Link>
