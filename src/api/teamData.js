const teamMembers = [
  ...
  },
  {
    ...
    description:
      "I am thrilled for the events we have planned this semester. With a background enriched by diverse opportunities, I’m eager to contribute and support all students embarking on their healthcare journey! Fun Fact: I love to spend my free time playing video games as well as soccer with my friends.",
    image: "/marwan.jpg",
  },
  {
    name: "Faatin Faisal",
  ...
  },
  {
    ...
    track: "Pre-Med",
    description:
      "I'm excited about serving as treasurer, meeting new members, and seeing all the great things we can accomplish this semester! I work as a medical assistant at an internal medicine clinic and am a research associate for TEMRAP. In my free time, I love baking, exploring cute coffee shops, and spending time with family.",
    image: "/ismahan.jpg",
  },
];
